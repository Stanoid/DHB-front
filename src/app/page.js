...
export default function Home() {
  ...
  const {message,setMesage,login} = useContext(MainContext);
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div class="space-y-4 md:space-y-6" >
                  ...
                  <div class="flex items-center justify-between">
                      ...
                      <a  class="text-sm hidden font-medium text-primary-600 hover:underline dark:text-primary-500">Forgot password?</a>
                  </div>
                  <div onClick={()=>{loginUser()}} style={{backgroundColor:MAIN_STYLE.primary}} class="w-full text-white bg-primary-600
                   hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300
                    font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600
                     dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</div>
