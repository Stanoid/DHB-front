...
function subel(props) {
    ...
    useEffect(() => {
      console.log("form effect",props.data)
      }, []);
...
<div style={{display:"flex",padding:2,justifyContent:"flex-start",width:"100%"}}>
   <div><span style={{fontWeight:"bold"}}> Name: </span> {props.data.attributes.user.data.attributes.name&&props.data.attributes.user.data.attributes.name}</div> 
    </div>
    <div style={{display:"flex",padding:2,justifyContent:"flex-start",width:"100%"}}>
   <div><span style={{fontWeight:"bold"}}> Email: </span> {props.data.attributes.user.data.attributes.email&&props.data.attributes.user.data.attributes.email}</div> 
    </div>

    <div style={{display:"flex",padding:2,justifyContent:"flex-start",width:"100%"}}>
   <div><span style={{fontWeight:"bold"}}> Country: </span> {props.data.attributes.user.data.attributes.country&&props.data.attributes.user.data.attributes.country}</div> 
    </div>

    <div style={{display:"flex",padding:2,justifyContent:"flex-start",width:"100%"}}>
   <div><span style={{fontWeight:"bold"}}> phone: </span> {props.data.attributes.user.data.attributes.phone&&props.data.attributes.user.data.attributes.phone}</div> 
    </div>
...
<div style={{display:"flex",padding:2,justifyContent:"flex-start",width:"100%"}}>
   <div><span style={{fontWeight:"bold"}}> Course: </span> {props.data.attributes.bill.bname&&props.data.attributes.bill.bname}</div> 
    </div>
    <div style={{display:"flex",padding:2,justifyContent:"flex-start",width:"100%"}}>
   <div><span style={{fontWeight:"bold"}}> Batch: </span> {props.data.attributes.bill.cname&&props.data.attributes.bill.cname}</div> 
    </div>

    <div style={{display:"flex",padding:2,justifyContent:"flex-start",width:"100%"}}>
   <div><span style={{fontWeight:"bold"}}> Price: </span> {props.data.attributes.bill.price&&props.data.attributes.bill.price}</div> 
    </div>
...
<span style={{marginRight:10}}>{props.data.attributes.paid==false&&props.data.attributes.paid==false?"Mark paid":"Paid"}</span> <FaCheckCircle/> </div>
</div>
    </div>
</div>
  ...
  <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
    <h3>ID Photo</h3>
  <img width={200} src={props.data.attributes.user.data.attributes.images.data[0].idphoto&&props.data.attributes.user.data.attributes.images.data[0].idphoto} />
    </div>

    <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
    <h3>ID Check Photo</h3>
    
    <img width={200} src={props.data.attributes.user.data.attributes.images.data[1].idcheckphoto&&props.data.attributes.user.data.attributes.images.data[1].idcheckphoto} />
    </div>
