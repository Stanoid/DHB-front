...
const Print = (props) => {
  ...
  return (
    ...
    <div style={{borderRadius:10}} class="flex h-screen w-full items-center justify-center bg-gray-600">
  <div class="w-80 rounded bg-gray-50 px-6 pt-8 shadow-lg">
    ...
    <div class="flex flex-col gap-3 pb-6 pt-2 text-xs">
      <table class="w-full text-left">
        ...
        <tbody>
          <tr class="flex">
            <td class="flex-1 py-1">{props.data.cname} - {props.data.bname} </td>
            <td class="min-w-[44px]">1</td>
            <td class="min-w-[44px]">{props.data.price}</td>
          </tr>
...
<button  onClick={handlePrint}>Save Receipt</button>
</div>
